...
$query_run = mysqli_query($con, "SELECT * FROM tbl_kategori WHERE id_kategori='$id_kategori'");
$data = mysqli_fetch_array($query_run);
?>
<div class="container-fluid">
    <div class="card shadow mb-4">
        <div class="col-lg-12 col-lg-offset-12 col-sm-6 col-sm-offset-4">
            <h4 style="text-align: center;" class="mt-3">Edit Data Kategori</h4>
            <div class="thumbnail">
                <form role="form" id="formInput">
                    <div class="form-group form-group-lg has-feedback">
                        <label for="id_kategori">ID Kategori</label>
                        <input type="text" name="id_kategori" id="id_kategori" value="<?= $data['id_kategori']; ?>" class="form-control textbox" readonly>
                        <i class="form-control-feedback"></i>
                        <span class="text-warning"></span>
                    </div>
                    <div class="form-group form-group-lg has-feedback">
                        <label for="kategori">Kategori</label>
                        <input type="text" name="kategori" id="kategori" value="<?= $data['nama_kategori']; ?>" class="form-control textbox">
                        <i class="form-control-feedback"></i>
                        <span class="text-warning"></span>
                    </div>
                    <button type="submit" name="btn-ubah" class="btn btn-primary btn-block mb-3">Ubah</button>
                </form>
            </div>
        </div>
    </div>
